...
public class OverdraftTierBandSetInner {
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL)
  private List<OverdraftFeesChargesInner1> overdraftFeesCharges = new ArrayList<>();
   ...
   */
  public OverdraftTierBandSetInner(TierBandMethodEnum tierBandMethod, List<OverdraftTierBandInner> overdraftTierBand) {
  ...
  public OverdraftTierBandSetInner overdraftType(@Nullable OverdraftTypeEnum overdraftType) {
  ...
  public OverdraftTierBandSetInner identification(@Nullable String identification) {
  ...
  public OverdraftTierBandSetInner authorisedIndicator(@Nullable Boolean authorisedIndicator) {
  ...
  public OverdraftTierBandSetInner bufferAmount(@Nullable String bufferAmount) {

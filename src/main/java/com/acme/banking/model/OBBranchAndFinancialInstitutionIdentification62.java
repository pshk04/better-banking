...
public class OBBranchAndFinancialInstitutionIdentification62 {
  ...
  public OBBranchAndFinancialInstitutionIdentification62 schemeName(@Nullable String schemeName) {
  ...
  public OBBranchAndFinancialInstitutionIdentification62 identification(@Nullable String identification) {
  ...
  public OBBranchAndFinancialInstitutionIdentification62 name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OBBranchAndFinancialInstitutionIdentification62 LEI(@Nullable String LEI) {
    this.LEI = LEI;
    return this;
  }
  ...
  public OBBranchAndFinancialInstitutionIdentification62 postalAddress(@Nullable OBPostalAddress7 postalAddress) {

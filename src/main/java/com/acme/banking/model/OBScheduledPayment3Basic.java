...
public class OBScheduledPayment3Basic {
   ...
   */
  public OBScheduledPayment3Basic(String accountId, Date scheduledPaymentDateTime, OBInternalScheduleType1Code scheduledType, OBActiveOrHistoricCurrencyAndAmount1 instructedAmount) {
  ...
  public OBScheduledPayment3Basic scheduledPaymentId(@Nullable String scheduledPaymentId) {
  ...
  public OBScheduledPayment3Basic reference(@Nullable String reference) {
  ...
  public OBScheduledPayment3Basic debtorReference(@Nullable String debtorReference) {

...
public class OBTransaction6Detail {
   ...
   */
  public OBTransaction6Detail(String accountId, OBCreditDebitCode1 creditDebitIndicator, ExternalEntryStatus1Code status, Date bookingDateTime, OBActiveOrHistoricCurrencyAndAmount9 amount) {
  ...
  public OBTransaction6Detail transactionId(@Nullable String transactionId) {
  ...
  public OBTransaction6Detail transactionReference(@Nullable String transactionReference) {
  ...
  public OBTransaction6Detail transactionMutability(@Nullable OBInternalTransactionMutability1Code transactionMutability) {
  ...
  public OBTransaction6Detail valueDateTime(@Nullable Date valueDateTime) {
  ...
  public OBTransaction6Detail transactionInformation(@Nullable String transactionInformation) {
  ...
  public OBTransaction6Detail addressLine(@Nullable String addressLine) {
  ...
  public OBTransaction6Detail chargeAmount(@Nullable OBActiveOrHistoricCurrencyAndAmount10 chargeAmount) {
  ...
  public OBTransaction6Detail currencyExchange(@Nullable OBCurrencyExchange5 currencyExchange) {
  ...
  public OBTransaction6Detail bankTransactionCode(@Nullable OBBankTransactionCodeStructure1 bankTransactionCode) {
  ...
  public OBTransaction6Detail proprietaryBankTransactionCode(@Nullable ProprietaryBankTransactionCodeStructure1 proprietaryBankTransactionCode) {
  ...
  public OBTransaction6Detail balance(@Nullable OBTransactionCashBalance balance) {
  ...
  public OBTransaction6Detail merchantDetails(@Nullable OBMerchantDetails1 merchantDetails) {
  ...
  public OBTransaction6Detail creditorAgent(@Nullable OBBranchAndFinancialInstitutionIdentification61 creditorAgent) {
  ...
  public OBTransaction6Detail creditorAccount(@Nullable OBCashAccount60 creditorAccount) {
  ...
  public OBTransaction6Detail debtorAgent(@Nullable OBBranchAndFinancialInstitutionIdentification62 debtorAgent) {
  ...
  public OBTransaction6Detail debtorAccount(@Nullable OBCashAccount61 debtorAccount) {
  ...
  public OBTransaction6Detail cardInstrument(@Nullable OBTransactionCardInstrument1 cardInstrument) {
  ...
  public OBTransaction6Detail categoryPurposeCode(@Nullable ExternalCategoryPurpose1Code categoryPurposeCode) {
  ...
  public OBTransaction6Detail paymentPurposeCode(@Nullable OBExternalPurpose1Code paymentPurposeCode) {
  ...
  public OBTransaction6Detail ultimateCreditor(@Nullable OBUltimateCreditor1 ultimateCreditor) {
  ...
  public OBTransaction6Detail ultimateDebtor(@Nullable OBUltimateDebtor1 ultimateDebtor) {

...
public class OBBranchAndFinancialInstitutionIdentification60 {
  ...
  public OBBranchAndFinancialInstitutionIdentification60 schemeName(@Nullable String schemeName) {
  ...
  public OBBranchAndFinancialInstitutionIdentification60 identification(@Nullable String identification) {
  ...
  public OBBranchAndFinancialInstitutionIdentification60 name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OBBranchAndFinancialInstitutionIdentification60 postalAddress(@Nullable OBPostalAddress7 postalAddress) {
  ...
  public OBBranchAndFinancialInstitutionIdentification60 LEI(@Nullable String LEI) {
    this.LEI = LEI;
    return this;
  }

...
public class OBReadBalance1DataBalanceInnerAmount {
  ...
  public OBReadBalance1DataBalanceInnerAmount subType(SubTypeEnum subType) {
  ...
  @Schema(name = "SubType", description = "Balance sub type, in a coded form. Default if not specified is BCUR of the account", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

...
public class OverdraftTierBandSetInner1 {
  ...
  public OverdraftTierBandSetInner1 overdraftType(@Nullable OverdraftTypeEnum overdraftType) {
  ...
  public OverdraftTierBandSetInner1 identification(@Nullable String identification) {
  ...
  public OverdraftTierBandSetInner1 authorisedIndicator(@Nullable Boolean authorisedIndicator) {
  ...
  public OverdraftTierBandSetInner1 bufferAmount(@Nullable String bufferAmount) {

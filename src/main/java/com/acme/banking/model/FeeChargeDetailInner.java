...
public class FeeChargeDetailInner {
  ...
  public FeeChargeDetailInner negotiableIndicator(@Nullable Boolean negotiableIndicator) {
  ...
  public FeeChargeDetailInner feeAmount(@Nullable String feeAmount) {
  ...
  public FeeChargeDetailInner feeRate(@Nullable String feeRate) {
  ...
  public FeeChargeDetailInner feeRateType(@Nullable FeeRateTypeEnum feeRateType) {
  ...
  public FeeChargeDetailInner calculationFrequency(@Nullable CalculationFrequencyEnum calculationFrequency) {
  ...
  public FeeChargeDetailInner otherFeeCategoryType(@Nullable OtherFeeCategoryType otherFeeCategoryType) {
  ...
  public FeeChargeDetailInner otherFeeType(@Nullable OtherFeeType1 otherFeeType) {
  ...
  public FeeChargeDetailInner otherFeeRateType(@Nullable OtherFeeRateType otherFeeRateType) {
  ...
  public FeeChargeDetailInner otherApplicationFrequency(@Nullable OtherApplicationFrequency otherApplicationFrequency) {
  ...
  public FeeChargeDetailInner otherCalculationFrequency(@Nullable OtherCalculationFrequency otherCalculationFrequency) {
  ...
  public FeeChargeDetailInner feeApplicableRange(@Nullable FeeApplicableRange feeApplicableRange) {

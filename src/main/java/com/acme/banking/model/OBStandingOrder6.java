...
public class OBStandingOrder6 {
  ...
  public OBStandingOrder6 standingOrderId(@Nullable String standingOrderId) {
  ...
  public OBStandingOrder6 nextPaymentDateTime(@Nullable Date nextPaymentDateTime) {
  ...
  public OBStandingOrder6 lastPaymentDateTime(@Nullable Date lastPaymentDateTime) {
  ...
  public OBStandingOrder6 numberOfPayments(@Nullable String numberOfPayments) {
  ...
  public OBStandingOrder6 standingOrderStatusCode(@Nullable ExternalMandateStatus1Code standingOrderStatusCode) {
  ...
  public OBStandingOrder6 firstPaymentAmount(@Nullable OBActiveOrHistoricCurrencyAndAmount2 firstPaymentAmount) {
  ...
  public OBStandingOrder6 nextPaymentAmount(@Nullable OBActiveOrHistoricCurrencyAndAmount3 nextPaymentAmount) {
  ...
  public OBStandingOrder6 lastPaymentAmount(@Nullable OBActiveOrHistoricCurrencyAndAmount11 lastPaymentAmount) {
  ...
  public OBStandingOrder6 finalPaymentAmount(@Nullable OBActiveOrHistoricCurrencyAndAmount4 finalPaymentAmount) {
  ...
  public OBStandingOrder6 creditorAgent(@Nullable OBBranchAndFinancialInstitutionIdentification51 creditorAgent) {
  ...
  public OBStandingOrder6 creditorAccount(@Nullable OBCashAccount51 creditorAccount) {
  ...
  public OBStandingOrder6 mandateRelatedInformation(@Nullable OBMandateRelatedInformation1 mandateRelatedInformation) {
  ...
  public OBStandingOrder6 remittanceInformation(@Nullable OBRemittanceInformation2 remittanceInformation) {

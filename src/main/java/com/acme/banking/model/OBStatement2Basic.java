...
public class OBStatement2Basic {
   ...
   */
  public OBStatement2Basic(String accountId, OBInternalStatementType1Code type, Date startDateTime, Date endDateTime, Date creationDateTime) {
  ...
  public OBStatement2Basic statementId(@Nullable String statementId) {
  ...
  public OBStatement2Basic statementReference(@Nullable String statementReference) {
  ...
  public OBStatement2Basic totalValue(@Nullable OBReadBalance1DataTotalValue totalValue) {

...
public class OBUltimateDebtor1 {
  ...
  public OBUltimateDebtor1 name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OBUltimateDebtor1 identification(@Nullable String identification) {
  ...
  public OBUltimateDebtor1 LEI(@Nullable String LEI) {
    this.LEI = LEI;
    return this;
  }
  ...
  public OBUltimateDebtor1 schemeName(@Nullable String schemeName) {
  ...
  public OBUltimateDebtor1 postalAddress(@Nullable OBPostalAddress7 postalAddress) {

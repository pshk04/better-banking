...
public class TierBandInner {
  ...
  public TierBandInner identification(@Nullable String identification) {
  ...
  public TierBandInner tierValueMaximum(@Nullable String tierValueMaximum) {
  ...
  public TierBandInner calculationFrequency(@Nullable CalculationFrequencyEnum calculationFrequency) {
  ...
  public TierBandInner depositInterestAppliedCoverage(@Nullable DepositInterestAppliedCoverageEnum depositInterestAppliedCoverage) {
  ...
  public TierBandInner bankInterestRateType(@Nullable BankInterestRateTypeEnum bankInterestRateType) {
  ...
  public TierBandInner bankInterestRate(@Nullable String bankInterestRate) {
  ...
  public TierBandInner otherBankInterestType(@Nullable OtherBankInterestType otherBankInterestType) {
  ...
  public TierBandInner otherApplicationFrequency(@Nullable OtherApplicationFrequency otherApplicationFrequency) {
  ...
  public TierBandInner otherCalculationFrequency(@Nullable OtherCalculationFrequency otherCalculationFrequency) {

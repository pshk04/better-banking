...
public class OBAccount6Detail {
  ...
  public OBAccount6Detail status(@Nullable OBInternalAccountStatus1Code status) {
    this.status = status;
    return this;
  }
  ...
  public OBAccount6Detail statusUpdateDateTime(@Nullable Date statusUpdateDateTime) {
  ...
  public OBAccount6Detail currency(@Nullable String currency) {
  ...
  public OBAccount6Detail accountCategory(@Nullable OBInternalAccountType1Code accountCategory) {
  ...
  public OBAccount6Detail accountTypeCode(@Nullable OBExternalAccountSubType1Code accountTypeCode) {
  ...
  public OBAccount6Detail description(@Nullable String description) {
  ...
  public OBAccount6Detail nickname(@Nullable String nickname) {
  ...
  public OBAccount6Detail openingDate(@Nullable Date openingDate) {
  ...
  public OBAccount6Detail maturityDate(@Nullable Date maturityDate) {
  ...
  public OBAccount6Detail switchStatus(@Nullable String switchStatus) {
  ...
  public OBAccount6Detail servicer(@Nullable OBBranchAndFinancialInstitutionIdentification50 servicer) {

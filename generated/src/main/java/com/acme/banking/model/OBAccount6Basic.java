...
public class OBAccount6Basic {
  ...
  public OBAccount6Basic status(@Nullable OBInternalAccountStatus1Code status) {
    this.status = status;
    return this;
  }
  ...
  public OBAccount6Basic statusUpdateDateTime(@Nullable Date statusUpdateDateTime) {
  ...
  public OBAccount6Basic currency(@Nullable String currency) {
  ...
  public OBAccount6Basic accountCategory(@Nullable OBInternalAccountType1Code accountCategory) {
  ...
  public OBAccount6Basic accountTypeCode(@Nullable OBExternalAccountSubType1Code accountTypeCode) {
  ...
  public OBAccount6Basic description(@Nullable String description) {
  ...
  public OBAccount6Basic nickname(@Nullable String nickname) {
  ...
  public OBAccount6Basic openingDate(@Nullable Date openingDate) {
  ...
  public OBAccount6Basic maturityDate(@Nullable Date maturityDate) {
  ...
  public OBAccount6Basic switchStatus(@Nullable String switchStatus) {

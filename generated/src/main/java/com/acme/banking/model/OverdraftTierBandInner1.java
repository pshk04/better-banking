...
public class OverdraftTierBandInner1 {
  ...
  public OverdraftTierBandInner1 identification(@Nullable String identification) {
  ...
  public OverdraftTierBandInner1 tierValueMax(@Nullable String tierValueMax) {
  ...
  public OverdraftTierBandInner1 overdraftInterestChargingCoverage(@Nullable OverdraftInterestChargingCoverageEnum overdraftInterestChargingCoverage) {
  ...
  public OverdraftTierBandInner1 bankGuaranteedIndicator(@Nullable Boolean bankGuaranteedIndicator) {
  ...
  public OverdraftTierBandInner1 EAR(@Nullable String EAR) {
    this.EAR = EAR;
    return this;
  }
  ...
  public OverdraftTierBandInner1 representativeAPR(@Nullable String representativeAPR) {

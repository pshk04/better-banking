...
@Schema(name = "OBCashAccount6_1", description = "Unambiguous identification of the account of the debtor, in the case of a credit transaction.")
...
public class OBCashAccount61 {
  ...
  public OBCashAccount61 schemeName(@Nullable String schemeName) {
  ...
  public OBCashAccount61 identification(@Nullable String identification) {
  ...
  public OBCashAccount61 name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OBCashAccount61 secondaryIdentification(@Nullable String secondaryIdentification) {
  ...
  public OBCashAccount61 proxy(@Nullable OBProxy1 proxy) {
    this.proxy = proxy;
    return this;
  }

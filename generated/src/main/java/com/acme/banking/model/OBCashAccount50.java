...
public class OBCashAccount50 {
  ...
  public OBCashAccount50 name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OBCashAccount50 secondaryIdentification(@Nullable String secondaryIdentification) {
  ...
  public OBCashAccount50 proxy(@Nullable OBProxy1 proxy) {
    this.proxy = proxy;
    return this;
  }

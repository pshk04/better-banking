...
public class OBScheduledPayment3Detail {
   ...
   */
  public OBScheduledPayment3Detail(String accountId, Date scheduledPaymentDateTime, OBInternalScheduleType1Code scheduledType, OBActiveOrHistoricCurrencyAndAmount1 instructedAmount, OBCashAccount51 creditorAccount) {
  ...
  public OBScheduledPayment3Detail scheduledPaymentId(@Nullable String scheduledPaymentId) {
  ...
  public OBScheduledPayment3Detail reference(@Nullable String reference) {
  ...
  public OBScheduledPayment3Detail debtorReference(@Nullable String debtorReference) {
  ...
  public OBScheduledPayment3Detail creditorAgent(@Nullable OBBranchAndFinancialInstitutionIdentification51 creditorAgent) {

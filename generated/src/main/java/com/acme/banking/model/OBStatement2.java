...
public class OBStatement2 {
   ...
   */
  public OBStatement2(String accountId, OBInternalStatementType1Code type, Date startDateTime, Date endDateTime, Date creationDateTime) {
  ...
  public OBStatement2 statementId(@Nullable String statementId) {
  ...
  public OBStatement2 statementReference(@Nullable String statementReference) {
  ...
  public OBStatement2 totalValue(@Nullable OBReadBalance1DataTotalValue totalValue) {
